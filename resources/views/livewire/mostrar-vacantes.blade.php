    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        ...
        md:items-center">
                <div class="space-y-3">
                    ...
                    <p class="text-sm text-gray-500">Último dia: {{ $vacante->ultimo_dia->format('d/m/Y') }}
                    </p>
                </div>
                ...
                uppercase text-center">{{$vacante->candidatos->count()}} Candidatos</a>
    ...
    <script>
        Livewire.on('mostrarAlerta', vacanteId => {
            Swal.fire({
                ...
                text: "Una vacante eliminada no se podra recuperar",
                icon: 'warning',
